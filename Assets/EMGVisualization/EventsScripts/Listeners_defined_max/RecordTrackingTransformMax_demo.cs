...
namespace TCPeasy
{
    public class RecordTrackingTransformMax_demo : MonoBehaviour
    {
        ...
        // For demo: use the controller for firing event from the controller position
        Transform _controller_transform;
        ...
        { 
            ...
            _controller_transform = GameObject.Find("Controller").transform;
        ...
        void ListenerStoreTransformList()
        {
            ...
            Vector3 pos = _controller_transform.position;
